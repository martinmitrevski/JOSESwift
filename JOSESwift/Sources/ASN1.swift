...
extension ASN1 {
    ...
    public func toRawSignature(octetLength: Int) throws -> Data {
        ...
        let rawSig = sigR.fixOctetLength(octetLength: octetLength) + sigS.fixOctetLength(octetLength: octetLength)
        return rawSig
    }
